############################################################################
###          Beautiful and informative data visualization in R:          ###
...
setwd("~/Desktop/EDS (Environmental Data Science) Course/course-repository-mzargari/Coding_Club_Tutorial_06_Data_vis_1")
...
# all column names became characters. (The X is R’s way of turning numbers into characters.) 
