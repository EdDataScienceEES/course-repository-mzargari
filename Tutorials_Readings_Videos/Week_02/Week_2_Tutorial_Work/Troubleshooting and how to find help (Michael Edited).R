...
# Michael Zargari's attempt at fixing this code

# Loading dplyr where we will use the filter() function
library(dplyr)

# Iimport edidiv from "import dataset" button
...
# We have all the values now, so we can visualize them quickly with the barplot() function
