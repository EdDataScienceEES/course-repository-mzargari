...
setwd("~/Desktop/EDS (Environmental Data Science) Course/course-repository-mzargari/Tutorials_Readings_Videos/Week 5/Week_5_Data")
...
anova(apples.m) # this is only a linear regression
...
# 3. scale-location plot (square roots of standardized residuals versus fitted values)
# 4. plot of residuals versus leverage that adds bands corresponding to Cook’s distances of 0.5 and 1

# Practicing generalized linear models----
